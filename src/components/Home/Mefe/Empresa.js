              ...
              <form onSubmit={handleSubmit} className="mb-3">
                  <div className="row">
                        ...
                        <div className="col-md-4">
                            <input type="text" name="name" value={name} placeholder="Ejem: FIDELAC S.A.C" className="form-control form-control-lg mb-2" onChange={handleEmpresa}  autoComplete="off"/>
                        </div>
                        <div className="col-md-4">
